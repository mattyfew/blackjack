(function (a) {
  ...
  var b = {},
    ...
    d = '<div class="dd-select"><input class="dd-selected-value" name="mf_dd_selected_value" type="hidden" /><a class="dd-selected"></a><span class="dd-pointer dd-pointer-down"></span></div>',
